...
/**
 * Export Center View wrapped in Payload admin template.
 ...
 */
export async function ExportCenterViewWithTemplate({
  initPageResult,
  params,
  searchParams,
  ...
  return (
    ...
    >
      <ExportCenterView userId={userId} />
    </DefaultTemplate>
  )
}

export default ExportCenterViewWithTemplate
